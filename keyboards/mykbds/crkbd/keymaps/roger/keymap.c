...
[_QWERTY] = LAYOUT_split_3x6_3_ex2(
        GRVTI,  QESC,         KC_W,         KC_E,         KC_R,        KC_T,    RM_NEXT, KC_B,          KC_Y,        KC_U,         KC_I,         KC_O,   PAT,        QTDQT, //MY_QTMCR,LT(0,KC_ESC)
        ASTPC,  KC_A,         KC_S,         KC_D,         KC_F,        KC_G,    RM_NEXT, KC_D,          KC_H,        KC_J,         KC_K,         KC_L, SCLCL,        SLBSL, //MY_OPMCR, //LT(0,KC_QUOT),LT(0,KC_Q)
